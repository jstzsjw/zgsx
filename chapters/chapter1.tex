...
\begin{enumerate}[{例}1.]
    ...
    \item 设$x_1=1$，$x_2=2$，当$n\geq 2$时，$x_{n+1}=\sqrt{x_n x_{n+1}}$，求
        ...
        \begin{enumerate}[(1)]
            \item
                \begin{align*}
                    &\ln x_{n+1}=\frac{1}{2}(\ln x_n+\ln x_{n-1})\\
                    &\ln x_{n+1}-\ln x_n=-\frac{1}{2}(\ln x_n-\ln x_{n-1})\\
                    &\therefore y_{n+1}=-\frac{1}{2}y_n\\
                    &y_2=\ln 2\\
                    &\therefore y_n=(-\frac{1}{2})^{n-2}\ln 2\\
                \end{align*}
            \item
                \begin{align*}
                    \sum_{k=2}^n y_k=\sum_{k=2}^n \ln 2(-\frac{1}{2})^{n-2}=\ln 2\frac{1-(-\frac{1}{2})^{n-1}}{\frac{3}{2}}
                \end{align*}
            \item
                \begin{align*}
                    &\lim_{n\to\infty}x_n=\exp\lim_{n\to\infty}\ln x_n\\
                    &=\exp\lim_{n\to\infty}[y_n+y_{n-1}+\dots+y_2+\ln x_1]\\
                    &=\exp\lim_{n\to\infty}\bigg[\sum_{k=2}^n y_k+\ln x_1\bigg]\\
                    &=\exp\lim_{n\to\infty}\bigg[\ln 2\frac{1-(-\frac{1}{2})^{n-1}}{\frac{3}{2}}+\ln 1\bigg]\\
                    &=\exp\Big[\ln 2\cdot\frac{2}{3}+0\Big]\\
                    &=\sqrt[3]{4}
                \end{align*}
        \end{enumerate}
    %例25
